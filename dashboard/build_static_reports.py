...
real SECOM dataset. Nothing here reuses or references the synthetic
wafer-map demo in ``simulations/``; that separation is deliberate so SECOM
results and synthetic demo results are never mixed in one output.
